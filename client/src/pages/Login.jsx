...
const Login = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-cover px-6 sm:px-0' 
      style={{ backgroundImage: `url(${assets.login_bg})`, backgroundPosition: "center 50%" }}>
      <div className="absolute inset-0 bg-black opacity-40"></div>
      <div className="w-full flex justify-between items-center p-4 sm:p-6 sm:px-24 absolute top-0">
        <img onClick={() => navigate("/")} src={assets.montoria_home} alt="montoria logo" 
        ...
        <div className='bg-white shadow-5xl p-10 rounded-lg shadow-lg w-full max-w-2xl flex'>
          ...
          <div className='w-full sm:w-1/2 text-black text-sm'>
            ...
            <form onSubmit={onSubmitHandler}>
              ...
              <p onClick={() => navigate("/reset-password")} className='mb-5 mt-2 pl-3 text-[#9d16be] cursor-pointer italic'>Forgot password?</p>
              ...
              <p className='text-gray-400 text-center text-xs mt-4'>Can&apos;t access your account? 
                <span onClick={handleEmailClick} className='text-[#9d16be] cursor-pointer underline'>Contact us</span>
              </p>
            </form>
          </div>
        </div>
